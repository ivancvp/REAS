   ...
   content: [
      ...
      table: {
              ...
              body: [
                      ...
                      [{text:'Revisó:',fontSize:7},{text:aprob_juridica+' – Dirección Jurídica.',fontSize:7}],
                      [{text:'Revisó:',fontSize:7},{text:'Martha Patricia Ortiz - Contrato No. 288 de 2019 - Dirección Jurídica.',fontSize:7}],
                      [{text:'Revisó:',fontSize:7},{text:'José Alejandro Ramírez Cano - Contrato No. 132 de 2019 – Dirección de Urbanizaciones y Titulación.',fontSize:7}],
                      [{text:'Aprobó C.L.:',fontSize:7},{text:'Natalia Andrea Hincapié Cardona - Directora de Urbanizaciones y Titulación ',fontSize:7}],
                      [{text:'\nArchivado en:',fontSize:7},{text:'\nSubserie Resolución Administrativa - Dirección General.',fontSize:7}]
                      ]
              },
              layout: 'noBorders'
