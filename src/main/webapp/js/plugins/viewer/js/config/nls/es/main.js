...
define({
    ...
    viewer: {
        ...
        titles: {
            header: 'Visor geográfico',
            pageTitle: 'Visor geográfico', // One configurable map viewer
            subHeader: 'Reasentamientos' // customize it at your will (the literal translation doesn’t sound good)
        },
        widgets: {
