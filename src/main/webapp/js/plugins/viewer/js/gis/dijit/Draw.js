define([
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        createGraphicLayers: function () {
            ...
            this.pointRenderer.label = 'Puntos Dibujados';
            this.pointRenderer.description = 'Puntos Dibujados';
            ...
            this.polylineRenderer.label = 'Líneas Dibujadas';
            this.polylineRenderer.description = 'Líneas Dibujadas';
            ...
            this.polygonRenderer.addValue({
                ...
                label: 'Polígonos Dibujados',
                description: 'Polígonos Dibujados'
            });
