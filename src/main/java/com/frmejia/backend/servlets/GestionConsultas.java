...
public class GestionConsultas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getSession().getAttribute("user") != null) {
                ...
                if (op != null) {
                    if (!op.isEmpty()) {
                        ...
                        //parametros.put("USUARIO_ID", new String[]{(String)UsuarioManager.getInfoSesion("usuario_id")});
                        /*
                    ...
                    Map error = new LinkedHashMap();
                    error.put("error", "Operación no definida" + op);
            ...
            Map error = new LinkedHashMap();
            error.put("error", "Operación no definida try");
