...
//                return tablaUsuario.getValueAt(0, tablaUsuario.findColumn("usuario_pwd")).toString()+"/"+usuarioPwd;
                return null;
            }
...
//            String[] listFunc = new String[1];
    ...
    public static Object getInfoSesion(String parte) {
        FacesContext context = FacesContext.getCurrentInstance();
        Map<String, Object> info = new HashMap<String, Object>();
        info = (Map<String, Object>) context.getExternalContext().getSessionMap().get("info");
